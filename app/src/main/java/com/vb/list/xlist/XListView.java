...
//    private static final String TAG = "XListView";
    ...
    private TextView mHeaderTime, header_hint_text, time_label;
    ...
    private void initWithContext(Context context) {
        ...
        header_hint_text = (TextView) mHeader.findViewById(R.id.header_hint_text);
        time_label = (TextView) mHeader.findViewById(R.id.time_label);
    ...
    public void setTextColor(int color) {
        ...
        header_hint_text.setTextColor(color);
